...
#PUT '/<int:customer_id>': Updates a specific Customer based on the id passed in through the url.
@customers_bp.route('/<int:customer_id>', methods=['PUT']) #test
...
#DELETE '/<int:customer_id>': Deletes a specific customer based on the id passed in through the url.
@customers_bp.route('/<int:customer_id>', methods=['DELETE']) #test
@limiter.limit("50/day")
@token_required
